...
from hidrokit.contrib.taruma import hk172, hk124, hk127
from hktaruma import hk126
...
t_dcr_st = pd.DataFrame(data=_DATA_ST, index=_INDEX_ST, columns=_COL_ST)
...
t_dcr_sw = pd.DataFrame(data=_DATA_SW, index=_INDEX_SW, columns=_COL_SW)
